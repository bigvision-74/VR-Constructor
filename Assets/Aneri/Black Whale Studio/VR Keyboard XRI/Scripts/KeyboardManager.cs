...
namespace Keyboard
{
    public class KeyboardManager : MonoBehaviour
    {
        ...
        [SerializeField] private TMP_InputField License_Field;
        //[SerializeField] private TMP_InputField outputField2;
        ...
        private void Awake()
        {
            OutputFieldSelection(username_Field); // by default the username field will be the output field.
        ...
        public void OutputFieldSelection(TMP_InputField outputFieldInput)
        {
            outputField = outputFieldInput;
        }
